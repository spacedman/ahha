...
DEBUG_TOOLBAR_CONFIG = {
    ...
    'SHOW_TOOLBAR_CALLBACK': 'ahha.settings.base.custom_show_toolbar',
...
WSGI_APPLICATION = 'ahha.wsgi.application'
...
SYSTEM_EMAIL_PREFIX = "[ahha]"

## Log settings

LOG_LEVEL = logging.INFO
HAS_SYSLOG = True
SYSLOG_TAG = "http_app_ahha"  # Make this unique to your project.
