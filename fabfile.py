"""
Starter fabfile for deploying the ahha project.
...
# CHANGEME
env.hosts = ['user@ahha.example.com']
env.code_dir = '/srv/www/ahha'
env.project_dir = '/srv/www/ahha/ahha'
env.static_root = '/srv/www/ahha/static/'
env.virtualenv = '/srv/www/ahha/.virtualenv'
env.code_repo = 'git@github.com:user/ahha.git'
env.django_settings_module = 'ahha.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/ahha/wsgi.py" % env.code_dir)
